...
### Released
- Shipped **pricing-experiment-studio** as a public artifact for teams dealing with business operations systems.
...
### Shipped
- Cut the first coherent internal version of **pricing-experiment-studio** with stable domain objects, review surfaces, and decision outputs.
